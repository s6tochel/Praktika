...
R_err = np.sqrt(R / 30)
I_err = I *0.01
R0_err = np.sqrt(R0 / 30)
I0_err = I0 * 0.01

yerr = np.sqrt((R_err / R)**2 + (I_err / I)**2 + (R0_err / R0)**2 + (I0_err/I0)**2)
...
to_latex_table([xdata, ydata, yerr], table_path+"abschirmung1b_figvals.txt", round_to=[1,3,3])
