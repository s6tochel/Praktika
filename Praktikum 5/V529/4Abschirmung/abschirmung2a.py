...
mu = -0.6873993695770604
dmu = 0.014372852833670435
...
to_latex_table([ydata, yerr], table_path+"T1.txt", round_to=3)
to_latex_table([mus, mus_err], table_path+"mus1.txt", round_to=3)
