...
plt.plot(np.linspace(0, -0.6, 20), np.ones(20)*(8877), color="g")
plt.plot(np.ones(20)*(-0.6), np.linspace(0, 8877, 20), color="g", label="Winkel maximaler Zählrate")
plt.legend()
