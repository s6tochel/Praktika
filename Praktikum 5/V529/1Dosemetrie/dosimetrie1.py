...
plt.figure()
plt.grid()
plt.errorbar(data1[0], data1[1]/R, xerr=data1[0]*0.01, yerr=data1[2]/R, fmt='o', label="Cu U=15kV", color='b', ms=2, zorder=10, alpha=1)
plt.errorbar(data2[0], data2[1]/R, xerr=data2[0]*0.01, yerr=data2[2]/R, fmt='o', label="Cu U=10kV", color='g', ms=2, zorder=9, alpha=1)
plt.errorbar(data3[0], data3[1]/R, xerr=data3[0]*0.01, yerr=data3[2]/R, fmt='o', label="Cu U=25kV", color='r', ms=2, zorder=8, alpha=1)
