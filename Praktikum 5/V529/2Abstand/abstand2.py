...
to_latex_table([xdata*10000, xerr*10000, ydata, yerr], table_path+"abstand2_figvals.txt", round_to=[2, 2, 2, 2])
...
plt.grid()
plt.errorbar(xdata, ydata, xerr=xerr, yerr=yerr, fmt='o', label="Mo Messwerte", color='b', ms=2, zorder=10, alpha=1)
