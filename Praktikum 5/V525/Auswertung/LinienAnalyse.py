...
txtfile_title = "Spektrum1.txt"

save_title = "Spektrum1"
figure_title = "Na Spektrum ohne angepasste Verstärkung (Rechte Seite)"
...
for i in range(len(ranges)):
    ...
    if gauss_fit_orders[i] == 1:
        ...
        data_file.write(f"{save_title} {peak_nr} {gauss_values[2]} {gauss_value_errors[2]} {gauss_values[3]} {gauss_value_errors[3]} {gauss_values[4]} {gauss_value_errors[4]}\n")
        peak_nr += 1

    if gauss_fit_orders[i] == 2:
        residuals = I_slice - double_gauss(n_slice, *popt)
        data_file.write(f"{save_title} {peak_nr} {gauss_values[2]} {gauss_value_errors[2]} {gauss_values[3]} {gauss_value_errors[3]} {gauss_values[4]} {gauss_value_errors[4]}\n")
        data_file.write(f"{save_title} {peak_nr + 1} {gauss_values[5]} {gauss_value_errors[5]} {gauss_values[6]} {gauss_value_errors[6]} {gauss_values[7]} {gauss_value_errors[7]}\n")
        peak_nr += 2
    ...
    if gauss_fit_orders[i] == 3:
        ...
        data_file.write(f"{save_title} {peak_nr} {gauss_values[2]} {gauss_value_errors[2]} {gauss_values[3]} {gauss_value_errors[3]} {gauss_values[4]} {gauss_value_errors[4]}\n")
        data_file.write(f"{save_title} {peak_nr + 1} {gauss_values[5]} {gauss_value_errors[5]} {gauss_values[6]} {gauss_value_errors[6]} {gauss_values[7]} {gauss_value_errors[7]}\n")
        data_file.write(f"{save_title} {peak_nr + 2} {gauss_values[8]} {gauss_value_errors[8]} {gauss_values[9]} {gauss_value_errors[9]} {gauss_values[10]} {gauss_value_errors[10]}\n")
        peak_nr += 3
...
# plot the data
plt.errorbar(n, I, yerr=I_err, fmt='o', label=f'Messfehler', color='orange', ms=2, zorder=1, alpha=0.8)
plt.errorbar(n, I, fmt='o', label='Messwerte', color='g', ms=3, zorder=2, alpha=0.8)
