...
Wie in der Abbildung \ref{fig:Landau} zu erkennen ist, ist der Verlauf der Landau-Verteilung nicht symmetrisch, sondern hat einen langen Schwanz in Richtung höherer Energieverluste.
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{figures/Landau.png}
...
\begin{figure}
    \centering
    \includegraphics[width=0.8\linewidth]{figures/Szintillator_Bändermodell.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\linewidth]{figures/SzintillatorAufbau.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{figures/Aufbau_Winkelverteilung.png}
...
\begin{itemize}
    \item \textbf{Z25}
    \item \textbf{Z12}
    \item \textbf{ODER} Signal von \textbf{D24}, \textbf{D23}, \textbf{D1} und \textbf{D2}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{figures/SchematischWinkelverteilung.png}
    \caption{Schematischer Aufbau der Winkelverteilungsmessung}
    \label{fig:AufbauWinkelverteilungLangzeit}
\end{figure}
Es werden also je 2 Detektoren, welche sich gegenüberliegen mit dem mittleren Detektor Z25 durch Diskriminatoren in ein Kooinzidenzmodul geschickt und dort von einem Stichzähler gezählt.
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{figures/Aufbau_Lebensdauermessung.pdf}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{figures/Aufbau_Zerfallsmessung.pdf}
...
Wenn dies geschehen ist wird durch ein Schalt-Flip-Flop ein Gate geöffnet. Durch dieses Gate gelangt eine $\SI{20}{\mega\hertz}$-Pulsfrequenz, dass auf ein zahn kaskadierten 1:20-Untersetzer mit
zugeordneten Sichtzählern wirkt. Nun kann es zu zwei Szenarien kommen, Ein Myon fliegt durch den Szintillator und löst das Koinzidenzmodul aus. Das Gate öffnet sich und die Zählrate wird gezählt, wenn:
\begin{itemize}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{figures/Schwellenspannung_Winkelverteilung.png}
...
Für eine bessere Sichtbarkeit wurden die Fehler in diesen Abbildungen wurden doppelt so groß dargestellt.
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{figures/Pulshöhenspektrum_Landau_ohne_fit.png}
    \caption{Pulshöhenspektrum gezoomt auf den Landauanteil}
    \label{fig:PulshoheWinkelverteilungLandauOhneFit}
\end{figure}
\begin{figure}
    \centering
    \includegraphics[width=0.8\textwidth]{figures/Pulshöhenspektrum_Landau_gemischt.png}
...
In der Abbildung \ref{fig:PulshoheWinkelverteilungmitFit} ist das Pulshöhenspektrum mit der Landau- und Gauss-Anpassung zu sehen.
...
\begin{table}[H]
    ...
    \begin{tabular}{|c|c|}
        ...
        $\chi^2$ & 1168 \\ \hline
    \end{tabular}
    \label{tab:GaussAnpassungPulshohe}
\end{table}
...
Wie im Abschnitt \enquote{Zufallskoinzidenz} beschrieben, wurde die Zufallskoinzidenzrate auf 2 Arten gemessen.
...
Aber qualitativ entspricht das schon noch unseren Erwartungen, da die zeitliche Zufallskoinzidenz fast bei 0 ist und die räumliche im Gegensatz zur Theorie eine viel höhere Rate hat, dass folgt dadurch, dass
...
Diese sind in der Tabelle \ref{tab:ZahlrateLebensdauer} zu finden und wurden über eine Gesamtmesszeit von $T=\SI{598756}{\second}$
...
\begin{figure}[H]
    ...
    \begin{subfigure}[b]{0.48\textwidth}
        ...
        \caption{Schwellenspannung aufgetragen gegen die nach dem Monitorkreis normierte Messkreis werte aus Tabelle \ref{tab:RohdatenSchwellspannungLebensdauer}}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{figures/Lebensdauer_fit_korrektur.png}
...
\section{Fazit}
Insgesamt kann davon gesprochen werden, dass die Durchführung gut gelungen ist, die Ergebnisse sind aussagekräftig und mögliche Fehlerquellen konnten identifiziert werden und deren Konsequenzen analysiert werden.
...
\end{displaymath}
ermittelt, wobei hier ein Fehler von 1 angenommen wurde, da es nur ganzzahlige Ereignisse geben kann.
